...
function mytime() {
  var a = new Date();
  var b = a.toLocaleTimeString("chinese", {
    hour12: false
  }).replace(/[\u4e00-\u9fa5]+/g, "").split(":").slice(0, 1);
  var e = a.toLocaleTimeString("chinese", {
    hour12: false
  }).replace(/[\u4e00-\u9fa5]+/g, "").split(":").slice(1, 2);
  var f = a.toLocaleTimeString("chinese", {
    hour12: false
  }).replace(/[\u4e00-\u9fa5]+/g, "").split(":").slice(2, 3);
